    ...
    <div className="user-page-root">
      <div className="content-container">
        ...
        <div className="step-container">
          <span className="step-span">Step 1: Enter an email and a password to be used with your account.</span>
          <div className="user-info-form">
            ...
            <button className="new-user-done-button" onClick={() => register()}>Done</button>
          </div>
        </div>
        <div className="step-container">
